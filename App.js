  ...
  calcuopration(opration) {
    switch (opration) {
      case 'history':
        ...
        break;
      case 'del':
        var txt = String(this.state.value).split('');
        txt.pop();
        this.setState({
          value: txt.join(''),
        });
      ...
      <View style={styles.contaner}>
        ...
        <View style={styles.bottompart}>
          <View style={styles.bottom}>
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => this.buttonpressed('clear')}
              style={{
                flex: 1,
                backgroundColor: '#C7F3F9',
            ...
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => this.calcuopration('del')}
              style={{
                flex: 1,
                backgroundColor: '#ADEBF8',
                justifyContent: 'center',
                alignItems: 'center',
              }}>
              <View>
            ...
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => this.calcuopration('%')}
              style={{
                flex: 1,
                backgroundColor: '#95DFF8',
                justifyContent: 'center',
                alignItems: 'center',
              }}>
              <View>
          ...
          <View style={styles.bottom}>
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => this.calcuopration('history')}
              style={{
                flex: 1,
                backgroundColor: '#ffffff',
                justifyContent: 'center',
